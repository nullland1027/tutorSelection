  ...
  <div class="container">
    <div class="header">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>一二轮选择结果</el-breadcrumb-item>
      </el-breadcrumb>
    ...
    <div class="content">
      <div class="content-title"> 
        当前结果：<span v-if="round===1">一轮选择结果</span>
        <span v-else-if="round===2">二轮选择结果</span>
        <span v-else-if="round===-1">管理员分配结果</span>
      </div>
...
export default {
  ...
  created () {
    ...
    this.$http.post('admin/students', { token: token }).then(function (res) {
      ...
      _this.round = res.data.data.round
    })
    this.loading = false
  },
  methods: {
